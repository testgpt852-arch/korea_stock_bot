...
ACTIONS = {
    # [버그수정] 매수유지를 신규매수보다 먼저 배치
    # 원인: "투자의견 매수 유지" 가 신규매수의 "투자의견 매수" 키워드에 먼저 걸리던 문제
    # 수정: 매수유지 키워드를 신규매수보다 먼저 검사 + "투자의견 매수 유지" 명시적 추가
    "목표가상향": ["목표가 상향", "목표주가 상향", "TP 상향", "목표가↑", "목표주가↑"],
    "매수유지":   ["매수 유지", "Buy 유지", "매수의견 유지", "투자의견 유지", "투자의견 매수 유지"],
