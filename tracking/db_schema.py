...
SQLite DB 스키마 정의 + 초기화 (Phase 3, v3.3 신규)
...
[테이블]
  ...
  trading_history        ← Phase 4 모의투자 매매 이력 (스키마 예약, 현재 미사용)
    ...
    try:
        ...
        c.execute("""
            CREATE TABLE IF NOT EXISTS trading_history (
                ...
                mode            TEXT DEFAULT 'VTS'  -- VTS=모의 / REAL=실전 (Phase 4 활성화)
            )
        """)
